...
preferences-answer-button-colors = Answer button colors
preferences-answer-correct-border = Correct answer border color
preferences-answer-incorrect-border = Incorrect answer border color
